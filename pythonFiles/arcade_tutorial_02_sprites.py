...
class MyGame(arcade.Window):
    ...
    def __init__(self): #Here we create the variables
   ...
   ##     self.wall_list = None might not be needed
        self.player_list = None
        self.meter_list = None
        


    def setup(self): #Here we create the object instances / graphical sprites
        
        ### Sprites. Drawing - Movement - Collision detection
        self.player_list = arcade.SpriteList()
        ##self.wall_list = arcade.SpriteList(
         ##   use_spatial_hash=True  ## for faster collision detection but slower sprite movement - walls won't move
       ## )
        self.meteor_list = arcade.SpriteList(); 
    
        ## Adding the images to the corresponding sprites
...
##        self.leftWall = arcade.Sprite() Might not be needed
