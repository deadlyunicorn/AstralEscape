...
class MyGame(arcade.Window):
    ...
    def setup(self): 
        ...
        self.player_sprite = arcade.Sprite("/media/student/F462-7117/Apps/Python_Final_Project/pythonFiles/assets/spacecraft.png",0.2) #file location , Sprite Scaling (1 = 100%)
    ...
    def on_update(self,delta_time):
        ...
        if(self.timeTrack!=seconds):
            ...
            if (self.timeTrack%5==0):
                ...
                coin=arcade.Sprite("/media/student/F462-7117/Apps/Python_Final_Project/assets/coin.png",0.1)
...
## 50-50 chance for which meteor to generate
                ...
                def meteorSpawn(): 
                    ...
                    if(meteorSpawnNum==1):
                        meteor=arcade.Sprite("/media/student/F462-7117/Apps/Python_Final_Project/assets/meteorite01.png",0.1)
                        ...
                        meteor2=arcade.Sprite("/media/student/F462-7117/Apps/Python_Final_Project/assets/meteorite02.png",0.1)
